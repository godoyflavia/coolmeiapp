...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // colors dictionary
        colorsDictionary["1"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        colorsDictionary["2"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        colorsDictionary["3"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        colorsDictionary["4"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        colorsDictionary["5"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
        colorsDictionary["6"] = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.memberColor.backgroundColor =
    }
